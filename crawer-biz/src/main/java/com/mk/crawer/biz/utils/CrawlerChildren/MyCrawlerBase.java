...
public class MyCrawlerBase  {
    ...
    public  MyCrawlerBase(String  tableMathType,String  tableMathName,int  ipAddressNum,
                          int  portNum,  int  proxyAddressNum,int  noteNum,int  typeNum){
        this.tableMathType = tableMathType;
        this.tableMathName = tableMathName;
        this.ipAddressNum = ipAddressNum;
        this.portNum = portNum;
        this.proxyAddressNum =proxyAddressNum;
