...
public class GdHotel {
    ...
    public void setNaviPoiId(String naviPoiId) {
        this.naviPoiId = naviPoiId == null ? null : naviPoiId.trim();
    }
    ...
    public void setEntrLocation(String entrLocation) {
        this.entrLocation = entrLocation == null ? null : entrLocation.trim();
    }
    ...
    public void setExitLocation(String exitLocation) {
        this.exitLocation = exitLocation == null ? null : exitLocation.trim();
    }
    ...
    public void setIndoorMap(Integer indoorMap) {
    ...
    public Integer getHotelOrdering() {
        return hotelOrdering;
    }

    public void setHotelOrdering(Integer hotelOrdering) {
