...
public class Multilist {
    ...
    @JSONField(name ="src_logo")
    private String srcLogo;
    @JSONField(name ="HotelCode")
    private String hotelcode;
    private String hours;
    @JSONField(name ="can_resell")
    private String canResell;
    ...
    @JSONField(name ="total_upperlimit")
    ...
    public void setSrcWeight(String srcWeight) {
        this.srcWeight = srcWeight;
    }
    public String getSrcWeight() {
        return srcWeight;
    }
    ...
    public void setCanResell(String canResell) {
        this.canResell = canResell;
    }
    public String getCanResell() {
        return canResell;
    }
